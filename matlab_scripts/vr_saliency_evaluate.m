...
folderName = '/home/lab-chen.dongwen/saliency/dataset/vr_data/vr_saliency_dataset/another_ground_truth';
exp_folder = '/157Dataset/data-chen.dongwen/icme_2017/graduation_project/MCP_vr_saliency_30_2048_drt/'
...
parfor i = 3:length(imlist)
    ...
    % read image
    SalMap1 = imread([folderName '/cubemap_' num2str(filenum) '.png']);
	SalMap1 = rgb2gray(SalMap1);
