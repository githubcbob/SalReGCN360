...
folder = '/home/lab-chen.dongwen/saliency/dataset/vr_data/vr_saliency_dataset/input_image';
sub_folder = '/'
outfolder = '/home/lab-chen.dongwen/ACSalNet/data/icme17_salicon_like/vr_saliency_30';
...
parfor i = 3:length(imlist)
    ...
    im_filename
    filenum = regexp(im_filename, 'cubemap_', 'split');
